        ...
        child: Column(
          children: _recognitions != null
              ? _recognitions.map((res) {
                  double score = res["confidence"] * 100;
                  return Padding(
                    padding: const EdgeInsets.only(top: 0),
                    child: Text(
                      //"${res["index"] + 1} - ${res["label"]}: ${res["confidence"].toStringAsFixed(3)}",
                      "This is a ${res["label"]}, I am ${score.toStringAsFixed(3)} % sure.",
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 20.0,
                      ),
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) {
              List<PopupMenuEntry<String>> menuEntries = [
                ...
                const PopupMenuItem<String>(
                  child: Text("None of these are implemented as of now."),
                  value: posenet,
                )
              ];
              return menuEntries;
